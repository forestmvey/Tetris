...
class Tetromino {
	...
	public:
		Tetromino(); // initialize a tetromino
		TetColor getColor() const; // return tetromino colour
		TetShape getShape(); // return tetromino shape
		static TetShape getRandomShape(); // return a random Tetromino shape
