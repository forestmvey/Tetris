...
public:
	...
	void getFillRow(int rowIndex, int content) {
		fillRow(rowIndex, content);
	}
	void getRemoveRow(int rowIndex) {
		removeRow(rowIndex);
	}
	void getCopyRowIntoRow(int rowIndex1, int rowIndex2) {
		copyRowIntoRow(rowIndex1, rowIndex2);
	}
	void getGetCompletedRows() {
		getGetCompletedRows();
	}
private:
